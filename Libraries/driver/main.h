...
void AppTaskBELLink(void *p_arg);
...
#define URART_4GRECV_LEN   300    //4G接收最大个数
#define MSG_RECV_LEN		50      //消息发送数据得最大个数 包括迪文串口接收
typedef struct
{
	uint32_t  count;		//上一次接收时间
...
extern _UART_RECV_CONTORL Uart2RecvControl;
extern _UART_4GRECV_CONTORL Uart1RecvControl;
extern _UART_RECV_CONTORL Uart3RecvControl;
