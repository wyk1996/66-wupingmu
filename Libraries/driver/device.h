...
#define BUZZER_OFF	                      __NOP;
#define BUZZER_ON	                        __NOP;
...
#define _BLE_RET_PORT					 	GPIOF
#define _BLE_RET							 PF6	// out
#define _BLE_RET_OFF						 GPIO_ResetBits(_BLE_RET_PORT,_BLE_RET);
#define _BLE_RET_ON						  GPIO_SetBits(_BLE_RET_PORT,_BLE_RET);
