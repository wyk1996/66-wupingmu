...
const _FALASH_TABLE FlashTable[FlALSH_TABLE_MAX]  = 
{
	...
	{HardFault  ,365*4*1024, 1024*4*1		},
	
	{CHARGE_PRIC  ,366*4*1024, 1024*4*1		},
	
	{APP_CODE  ,388*4*1024, 1024*4*50		},    //程序  1  0x55 表示需要升级  非 0x55表示需要升级；2 - 5  表示程序长度    6以后全部是程序  
