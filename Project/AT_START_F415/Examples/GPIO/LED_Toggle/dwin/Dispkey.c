...
void HYKeyEvent14(_LCD_KEYVALUE *keyval)   //系统配置第2页
{
    ...
    case LCD_KEY9:      //B0
        DisSysConfigInfo.cardtype=B0card;
        Munu13_ShowSysInfo();
        break;
    case LCD_KEY10:      //B1
        DisSysConfigInfo.cardtype=B1card;
        Munu13_ShowSysInfo();
        break;

    case LCD_KEY11:      //C0
        DisSysConfigInfo.cardtype=C0card;
        Munu13_ShowSysInfo();
        break;
    case LCD_KEY12:      //C1
        DisSysConfigInfo.cardtype=C1card;
        Munu13_ShowSysInfo();
        break;
...
void HYKeyEvent20(_LCD_KEYVALUE *keyval)
{
    ...
    case LCD_KEY8:				//6点
        PrintNum16uVariable(0x1A0D,0);
        break;
    case LCD_KEY9:				//12点
        PrintNum16uVariable(0x1A0D,8);
        break;
    case LCD_KEY10:				//18点
        PrintNum16uVariable(0x1A0D,13);
        break;
    case LCD_KEY11:				//23点
        PrintNum16uVariable(0x1A0D,21);
        break;
    case LCD_KEY14:				//确定按钮：按时间
