...
/* Private functions--------------------------------------------------------------------------*/
#define  IO_4G_ONOFF    11  //PA11 
#define  IO_4G_RES  	12 //PA12
#define  IO_4G_PWR  	8  //PA8
...
extern _NET_CONFIG_INFO  NetConfigInfo;
extern uint8_t SIMNum[15];
extern uint8_t _4GIMEI[15];
...
extern _RESEND_BILL_CONTROL ResendBillControl;
...
* Contributor  : 2021年3月19日
*****************************************************************************/
uint8_t   YKC_SendBalanceAck(void);
...
* Contributor  : 2018年7月27日
*****************************************************************************/
uint8_t  _4G_SendFrameDispose(void);
...
**note(s)    :
**Author     :CSH
**Create_Time:2023年7月19日12:59:51
***************************************************************/
